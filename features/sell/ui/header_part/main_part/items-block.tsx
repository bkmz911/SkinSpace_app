...
import { ErrorBlock, WarningBlock } from "@/shared/ui";
...
export const ItemsBlock = async ({ game, sort, sortOrder }: ItemsBlockProps) => {
    try {
        const items: InventoryResponse = await getInventory({ game, sort, sortOrder });
